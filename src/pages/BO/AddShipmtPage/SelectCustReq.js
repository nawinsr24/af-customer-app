...
function SelectCustReq({ handleClose, open, trkOpReqId, handleMatClose }) {
    const { t } = useTranslation();
    const ddArr = [
        { value: "name", label: t("bo.selCustReq.cust"), },
        { value: "reqId", label: t("bo.selCustReq.reqId"), },
        { value: "mobile", label: t("bo.selCustReq.contact"), },
        { value: "from", label: t("bo.selCustReq.from"), },
        { value: "to", label: t("bo.selCustReq.to"), },
        { value: "fromto", label: t("bo.selCustReq.fromTo"), },
        { value: "loadType", label: t("bo.selCustReq.loadType"), },
        { value: "matType", label: t("bo.selCustReq.mat"), }
    ];
        ...
        >
            <Box sx={modalStyle} height={600}>
                ...
                <Stack direction={'row'} justifyContent="space-between" alignItems={"center"} mb={1.2} mt={0.4} px={2}>
                    <Typography variant='h5' sx={{ fontWeight: "bold" }}>{t("bo.selCustReq.custReq")}</Typography>
                ...
                {view === 'list' ? <CustReqTablePopup custReqRow={reqRows?.data} handleClose={handleClose} handleReqCLick={handleReqCLick} /> :
                    <ScrollBox height={"84%"}>
